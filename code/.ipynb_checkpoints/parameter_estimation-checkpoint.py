...
def main():
    ...
    for i, eventname in enumerate(eventname_list):
        ...
        samples = run_parameter_estimation(eventname, t_merger_guess, mchirp_guess, event_pars)

        # save the samples
        save_fn = os.path.join(event_dir_list[i], 'posterior_samples')
